...
type HelloRequest struct {
	...
	Age           int32                  `protobuf:"varint,2,opt,name=age,proto3" json:"age,omitempty"`  //不支持int类型必须是int32或int64
...
const file_helloworld_proto_rawDesc = "" +
	...
	"\x05Hellp\x127\n" +
	"\x05Hello\x12\x18.helloworld.HelloRequest\x1a\x14.helloworld.ResponseB\x0fZ\r./;helloworldb\x06proto3"
...
var file_helloworld_proto_depIdxs = []int32{
	0, // 0: helloworld.Hellp.Hello:input_type -> helloworld.HelloRequest
	1, // 1: helloworld.Hellp.Hello:output_type -> helloworld.Response
