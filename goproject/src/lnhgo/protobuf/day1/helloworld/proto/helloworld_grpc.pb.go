...
const (
	Hello_Hello_FullMethodName = "/helloworld.Hello/Hello"
)
...
func (c *helloClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReponse, error) {
...
func (UnimplementedHelloServer) Hello(context.Context, *HelloRequest) (*HelloReponse, error) {
