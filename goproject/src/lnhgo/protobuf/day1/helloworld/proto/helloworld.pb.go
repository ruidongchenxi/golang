...
type HelloRequest struct {
	...
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` //编号1
...
const file_helloworld_proto_rawDesc = "" +
	...
	"\fHelloReponse\x12\x14\n" +
	"\x05reply\x18\x01 \x01(\tR\x05reply2D\n" +
	"\x05Hello\x12;\n" +
	"\x05Hello\x12\x18.helloworld.HelloRequest\x1a\x18.helloworld.HelloReponseB\x0fZ\r./;helloworldb\x06proto3"
...
var file_helloworld_proto_goTypes = []any{
	...
	(*HelloReponse)(nil), // 1: helloworld.HelloReponse
}
var file_helloworld_proto_depIdxs = []int32{
	0, // 0: helloworld.Hello.Hello:input_type -> helloworld.HelloRequest
	1, // 1: helloworld.Hello.Hello:output_type -> helloworld.HelloReponse
