...
type HelloRequest struct {
	...
	G             Gender                 `protobuf:"varint,3,opt,name=g,proto3,enum=Gender" json:"g,omitempty"` //枚举类型
...
const file_Hello_proto_rawDesc = "" +
	"\n" +
	"\vHello.proto\x1a\n" +
	"base.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xdf\x01\n" +
	"\fHelloRequest\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x15\n" +
	"\x01g\x18\x03 \x01(\x0e2\a.GenderR\x01g\x12%\n" +
	"\x02mp\x18\x04 \x03(\v2\x15.HelloRequest.MpEntryR\x02mp\x124\n" +
	"\aaddTime\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\aaddTime\x1a5\n" +
	"\aMpEntry\x12\x10\n" +
	...
	"\x06FEMALE\x10\x012H\n" +
	"\aGreeter\x12&\n" +
	"\bSayHello\x12\r.HelloRequest\x1a\v.HelloReply\x12\x15\n" +
	"\x04Ping\x12\x06.Empty\x1a\x05.PongB\tZ\a.;protob\x06proto3"
...
var file_Hello_proto_depIdxs = []int32{
	...
	5, // 4: Greeter.Ping:input_type -> Empty
